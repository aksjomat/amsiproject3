...
class Ruchy extends Tablica
{
	...
	public void klikniecie(int x,int y,Plansza p, Bicia b)
	{
		...
		{
			this.zerowanie();
			if (p.pole[x][y] > 1) //jeĹĽeli w polu znajduje siÄ™ pionek
			{	
				this.pole[x][y] = 1; //obecnie zaznaczony pionek

				
				//jeĹĽeli jest to pionek gracza 1
				...
				//jeĹĽeli jest to pionek racza 2
				...
				//jeĹĽeli jest to damka gracza 1 lub gracza 2
